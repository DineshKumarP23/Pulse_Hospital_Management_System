...
export declare const useToast: (inProps?: unknown) => import("@primereact/types/core").HeadlessInstance<import("@primereact/types/headless/toast").UseToastProps, unknown, {
    state: {
        mounted: boolean;
        swiping: boolean;
        swipeOut: boolean;
    ...
    isVisible: boolean;
    isFront: boolean;
    toaster: import("@primereact/types/primitive/toaster").ToasterRootInstance | undefined;
    rootProps: {
        ...
        'aria-atomic': "true";
        'aria-hidden': boolean;
        'data-swipe-direction': "left" | "right" | "up" | "down" | null;
        'data-index': number;
    };
    actionProps: {
        'data-scope': "toast";
