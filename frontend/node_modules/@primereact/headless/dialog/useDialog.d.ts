...
export declare const useDialog: (inProps?: unknown) => import("@primereact/types/core").HeadlessInstance<import("@primereact/types/headless/dialog").UseDialogProps, unknown, {
    state: {
    ...
    setPositionerRef: (node: HTMLElement | null) => void;
