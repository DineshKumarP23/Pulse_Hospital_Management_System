...
import { Area, Bar, CartesianGrid, ComposedChart, Label, LabelList, Legend, Line, ReferenceArea, ReferenceDot, ReferenceLine, ResponsiveContainer, Tooltip as Tooltip$1, XAxis, YAxis } from "recharts";
