...
import { Bar, BarChart, CartesianGrid, Label, LabelList, Legend, Rectangle, ReferenceArea, ReferenceDot, ReferenceLine, ResponsiveContainer, Tooltip as Tooltip$1, XAxis, YAxis } from "recharts";
