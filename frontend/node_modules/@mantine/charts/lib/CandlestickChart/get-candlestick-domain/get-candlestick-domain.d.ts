export declare function isRenderableValue(value: unknown): value is number;
 ...
 */
export declare function getCandlestickDomain({ data, openKey, highKey, lowKey, closeKey, }: GetCandlestickDomainInput): [number, number] | undefined;
export {};
