import type { BrushProps, CartesianGridProps, DotProps, LabelProps, LegendProps, ReferenceAreaProps, ReferenceDotProps, ReferenceLineProps, TooltipProps, XAxisProps, YAxisProps } from 'recharts';
...
export type BaseChartStylesNames = 'root' | 'container' | 'axis' | 'grid' | 'referenceLine' | 'referenceArea' | 'referenceDot' | 'axisLabel' | 'brush';
