			...
			children: [
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)(recharts.Funnel, {
					data: data.map((entry, index) => ({
						...
						fillOpacity: highlightedIndex !== null ? highlightedIndex === index ? 1 : .2 : 1
					})),
					dataKey: "value",
				...
				withLegend && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(recharts.Legend, {
					...
					content: () => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_ChartLegend.ChartLegend, {
						payload: data.map((item, index) => ({
							value: item.name,
							color: (0, _mantine_core.getThemeColor)(item.color, theme),
							dataKey: item.name,
							highlightKey: index
						})),
