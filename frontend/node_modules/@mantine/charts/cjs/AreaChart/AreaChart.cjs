...
const AreaChart = (0, _mantine_core.factory)((_props) => {
	...
	const referenceLinesItems = referenceLines?.map(({ color: lineColor, labelPosition, ...line }, index) => {
		const color = (0, _mantine_core.getThemeColor)(lineColor, theme);
	...
	const referenceAreasItems = referenceAreas?.map(({ color: areaColor, labelPosition, ...area }, index) => {
		const color = (0, _mantine_core.getThemeColor)(areaColor, theme);
		return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(recharts.ReferenceArea, {
			fill: areaColor ? color : "var(--chart-grid-color)",
			fillOpacity: .2,
			stroke: areaColor ? color : "var(--chart-grid-color)",
			strokeOpacity: .6,
			yAxisId: area.yAxisId || void 0,
			...area,
			label: {
	...
	const referenceDotsItems = referenceDots?.map(({ color: dotColor, labelPosition, ...dot }, index) => {
		const color = (0, _mantine_core.getThemeColor)(dotColor, theme);
		return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(recharts.ReferenceDot, {
			r: 5,
			fill: dotColor ? color : "var(--chart-grid-color)",
			stroke: "var(--mantine-color-body)",
			strokeWidth: 2,
			yAxisId: dot.yAxisId || void 0,
			...dot,
			label: {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_mantine_core.Box, {
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(recharts.ResponsiveContainer, {
			...
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(recharts.AreaChart, {
				data,
				stackOffset: type === "percent" ? "expand" : type === "stream" ? "wiggle" : void 0,
				layout: orientation,
				margin: {
