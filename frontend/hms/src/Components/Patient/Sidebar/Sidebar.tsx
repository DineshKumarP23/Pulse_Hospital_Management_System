...
import { IconHeartbeat, IconLayoutGrid, IconStethoscope, IconVaccine, IconUser } from '@tabler/icons-react';
...
const links = [
    ...
    {name: "Appointments", url: "/patient/appointments", icon: <IconStethoscope stroke={1.5} /> },
]
