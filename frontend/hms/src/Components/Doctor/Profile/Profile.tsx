...
import { bloodGroups, doctorDepartments } from "../../../Data/DropdownData";
                ...
                <Table striped stripedColor="primary.1" verticalSpacing="md" withRowBorders={false}>
                    <Table.Tbody className="[&>tr]:!mb-3">
                        <Table.Tr>
                            ...
                            {editMode ? <Table.Td className="text-xl"> <DateInput placeholder="Date of Birth" /> </Table.Td>:<Table.Td className="text-xl">{doctor.dob}</Table.Td>}
                        </Table.Tr>
                        <Table.Tr>
                            <Table.Td className="font-semibold text-xl">Phone</Table.Td>
                            {editMode ? <Table.Td className="text-xl"> <NumberInput maxLength={10} placeholder="Phone Number" clampBehavior="strict" hideControls /></Table.Td>:<Table.Td className="text-xl">{doctor.phone}</Table.Td>}
                        </Table.Tr>
                        <Table.Tr>
                        ...
                        <Table.Tr>
                            ...
                            {editMode ? <Table.Td className="text-xl"> <NumberInput maxLength={12} placeholder="License Number" clampBehavior="strict" hideControls /></Table.Td>:<Table.Td className="text-xl">{doctor.licenseNo}</Table.Td>}
                        </Table.Tr>
                        <Table.Tr>
                            <Table.Td className="font-semibold text-xl">Specialization</Table.Td>
                            {editMode ? <Table.Td className="text-xl"> <Select placeholder="Specialization" data={bloodGroups}/></Table.Td>:<Table.Td className="text-xl">{doctor.specialization}</Table.Td>}
                        </Table.Tr>
                        <Table.Tr>
                            <Table.Td className="font-semibold text-xl">Department</Table.Td>
                            {editMode ? <Table.Td className="text-xl"> <Select placeholder="Departments" data={doctorDepartments}/></Table.Td>:<Table.Td className="text-xl">{doctor.departments}</Table.Td>}
                        </Table.Tr>
                        <Table.Tr>
